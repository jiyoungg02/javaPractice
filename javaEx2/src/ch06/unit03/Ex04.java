...
public class Ex04 {
	...
	public static void main(String[] args) {
		...
		/*
		// 클래스변수를 객체로 접근할 수 있지만 권장하지 않음(경고)
		t1.c = 50;
		System.out.println(t1.c + "," + t2.c); //50,50
		*/
		//클래스변수, 클래스메소드는 클래스명으로 접근한다.
...
class Test4{
	...
	int b = 10; // 메모리를 할당받을때 10으로 초기화
	
	// System.out.println("test"); //컴오류. 선언부에서는 실행문이 올 수 없다.
